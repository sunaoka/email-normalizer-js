...
```bash
pnpm add git+https://github.com/sunaoka/email-normalizer-js#0.3.0
```

```bash
npm install git+https://github.com/sunaoka/email-normalizer-js#0.3.0
```

```bash
yarn add git+https://github.com/sunaoka/email-normalizer-js#0.3.0
```
